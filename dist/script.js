...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'hor', '.main-prev-btn', '.main-next-btn');
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          item.style.display = 'none'; //Добавим анимацию появления модального окна:
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  activateAnimation(); //Если пользователь наводит мышь, то интервал очистится и автом.перелистывание перестанет происх.
